...
//you need to modify code in here and handle_request() to support I/O multiplexing
    ...
    switch (header.req.op) {
      ...
      case CSIEBOX_PROTOCOL_OP_SYNC_META:
        ...
        if (complete_message_with_header(conn_fd, &header, &meta)) {
          //here is where you handle sync_meta and even sync_file request from client
